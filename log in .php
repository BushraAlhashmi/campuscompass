        ...
        <div id="id01" class="modal">
          <form class="modal-content animate" action="registration.html" method="post">
            <div class="container">
              ...
              <button class="btn btn-primary" href="registration.html">  log in </button>
              <label>
        ...
        <button style="margin-left: 45%;margin-right: 30%; width: 100px; height: 70px;" onclick="document.getElementById('id02').style.display='block'" style="width:auto; align-items: center;">Register</button>
          <div id="id02" class="modal">
             ...
             <form class="modal-content animate" action="registration.html" method="post">
                ...
                <label for="name"><b> Your Full name</label>
                <input type="text" placeholder= "Enter name test" name="name" required><br>
                ...
                <input type="number" placeholder="Phone Number" name="phoneNum" required><br/><br/>
        
        
                <lablel for = "email"><b> Email </b></label>
