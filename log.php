...
input[type=text], input[type=password] {
  ...
  border: 1px solid rgb(182, 203, 221);
...
button {
  background-color: rgba(13, 5, 42, 0.73);
  color: white;
  padding: 14px 20px;
  margin: 8px 0;
  border: none;
...
.modal {
  ...
  background-color: rgba(19, 13, 51, 0.752); /* Fallback color */
  background-color: rgba(228, 225, 240, 0.752); /* Black w/ opacity */
  padding-top: 60px;
}

/* Modal Content/Box */
.modal-content {
  background-color:rgb(196, 197, 204);
...
h2  {color: rgb(75, 130, 231)}
h6 {color: rgb(112, 99, 99)}
.close:hover,
.close:focus {
  color: rgb(46, 20, 119);
  cursor: pointer;
...
<body>
	...
	<div class="container py-3 ;"style="position :absolute ; ">
        ...
        <h6 style="text-align:center;">sign in into your online account </h3>
            <br>
            <br>
        <button style="margin-left: 45%;margin-right: 30%; width: 100px; height: 70px;" onclick="document.getElementById('id01').style.display='block'"  >Login</button>
        <div id="id01" class="modal">
          <form class="modal-content animate" action="registration.html" method="post">
            <div class="container">
              ...
              <button class="btn btn-primary" href="srvices.html">  log in </button>
              <label>
            ...
            <div class="container" >
              <button  type="button" onclick="document.getElementById('id01').style.display='none'; " class="cancelbtn"style="align-items:center">Cancel</button>
        ...
        <br>
        <br>
        <h2 style="text-align:center;">if you are a new client </h2>
        <h6 style="text-align:center;"> if you want a services to be ordered !
        </h3>
        <br>
        <br>
        <br>
        <button style="margin-left: 45%;margin-right: 30%; width: 100px; height: 70px;" onclick="document.getElementById('id02').style.display='block'" style="width:auto; align-items: center;">Register</button>
        ...
        <input type="text" name="newPhone" id="newPhone" required><br><br>
        
        <label for="newPassword">Password:</label>
        <input type="password" name="newPassword" id="newPassword" required><br><br>
        
        <input type="submit" name="insert" value="Insert">
   </div>  <p style="text-align:center">By creating an account you agree to our <a href="#" style="color:dodgerblue">Terms & Privacy</a>.</p>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["insert"])) {
        ...
        $insertQuery = "INSERT INTO users (Name, Email, Password, Phone_no) VALUES ('$newName', '$newEmail', '$newPassword', '$newPhone')";
...
<footer style=" text-align: center; font-family: 'Times New Roman', Times, serif; margin-left: 0;
    margin-right: 0;    width: 100%; position: fixed; 
padding: 3px;
